...
function Navbar({ setSearch }) {
  ...
  return (
    ...
    <nav className=' flex justify-between items-center p-[10px] bg-[#0000003b]'>
      ...
      <input type='text' placeholder='Search....' onChange={handleSubmit} onKeyPress={handleKeyPress} className='bg-[#ffffff36] text-white py-[2px] px-[10px] sm:p-[6px] lg:p-[8px] text-[19px] rounded-[4px] placeholder-white w-44 sm:w-56 md:w-72  lg:w-96' />
    </nav>
  )
}
